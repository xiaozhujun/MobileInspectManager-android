typedef int HANDLE;
//	int open_device_hid(unsigned long ulTotalTimeOuts, unsigned long ulMultiTimeOuts,unsigned long ulVID,unsigned long ulPID);
	int open_device_com(unsigned char nPort,unsigned int uBaud);
